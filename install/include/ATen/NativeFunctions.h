...
CAFFE2_API Tensor & quantized_adaptive_avg_pool3d_out(Tensor & out, const Tensor & self, IntArrayRef output_size);
...
CAFFE2_API Tensor quantized_adaptive_avg_pool3d(const Tensor & self, IntArrayRef output_size);
